...
function base_theme_scripts() {
	...
	wp_enqueue_script( 'base-theme-navigation', get_template_directory_uri() . '/js/plugin-controller.js', array(), '20151215', true );

	wp_enqueue_style( 'base-theme-navigation', get_template_directory_uri() . '/css/main.css', array(), '20151215', true );
